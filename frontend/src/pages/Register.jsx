...
const Register = () => {
  ...
  // ============================================
  // Styles - Premium Industrial Glass (same as Login)
  // ============================================
  ...
  const inputStyle = {
    '& .MuiOutlinedInput-root': {
      ...
      '&.Mui-focused fieldset': { borderColor: '#b8ff00', borderWidth: '1px' },
      '&.Mui-focused': { boxShadow: '0 0 0 3px rgba(184, 255, 0, 0.08)' },
    },
    '& .MuiInputLabel-root': {
      color: 'rgba(255, 255, 255, 0.5)',
      '&.Mui-focused': { color: '#b8ff00' },
    },
      ...
      <Container maxWidth="sm" sx={{ position: 'relative', zIndex: 1 }}>
        <Paper elevation={0} sx={glassCardStyle}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 4 }}>
            ...
            >
              <PersonAdd sx={{ fontSize: 32, color: '#b8ff00' }} />
            </Box>
            ...
            <Typography 
              variant="body2" 
              sx={{ color: 'rgba(255, 255, 255, 0.5)', letterSpacing: '0.03em' }}
            >
          ...
          <Box component="form" onSubmit={handleSubmit}>
                  ...
                  <InputAdornment position="end">
                    <IconButton
                      ...
                      sx={{
                        ...
                        '&:hover': { color: '#b8ff00', bgcolor: 'rgba(184, 255, 0, 0.08)' },
                      }}
                    >
            ...
            >
              {isLoading ? <CircularProgress size={24} sx={{ color: '#b8ff00' }} /> : 'S\'inscrire'}
            </Button>
            ...
            <Box sx={{ textAlign: 'center', mt: 3 }}>
              <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.5)' }}>
                ...
                <Link 
                  to="/login" 
                  style={{ textDecoration: 'none', color: '#b8ff00', fontWeight: 500 }}
                >
                  Se connecter
                </Link>
              </Typography>
